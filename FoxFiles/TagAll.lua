...
if redis:get(DevProx.."Abs:TagAll:Time"..msg.chat_id_..':'..msg.sender_user_id_) then  
SendFoX(msg.chat_id_, msg.id_, 1, '⌁︙انتظر دقيقه بعد ارسال الامر', 1, 'md')
return false  
end
redis:setex(DevProx..'Abs:TagAll:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
