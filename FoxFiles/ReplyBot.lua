...
if not redis:get(DevProx..'Abs:Lock:Reply'..msg.chat_id_) then
...
SendFoX(msg.chat_id_, msg.id_, 1,rd, 1, 'html')
end
if text == 'دي' or text == 'ديي' or text == 'دي بابه' then 
DevProxTEAM =  "آخلُِآقٌڪڪ لُِڪڪ 𖠙 😒🔪"
SendFoX(msg.chat_id_, msg.id_, 1, DevProxTEAM, 1, 'md') 
return false
end
...
redis2 = math.random(#DevProxTEAM) 
SendFoX(msg.chat_id_, msg.id_, 1, DevProxTEAM[redis2] , 1, 'md') 
return false
end
...
if not redis:get(DevProx..'Abs:Lock:Reply'..msg.chat_id_) then
SendFoX(msg.chat_id_, msg.id_, 1, '⌁︙ردود البوت بالتاكيد مفعله ', 1, 'md')
else
SendFoX(msg.chat_id_, msg.id_, 1, '⌁︙تم تفعيل ردود البوت', 1, 'md')
redis:del(DevProx..'Abs:Lock:Reply'..msg.chat_id_)
end end
if text == 'تعطيل ردود البوت' or text == 'تعطيل الردود' then
if redis:get(DevProx..'Abs:Lock:Reply'..msg.chat_id_) then
SendFoX(msg.chat_id_, msg.id_, 1, '⌁︙ردود البوت بالتاكيد معطله ', 1, 'md')
else
redis:set(DevProx..'Abs:Lock:Reply'..msg.chat_id_,true)
SendFoX(msg.chat_id_, msg.id_, 1, '⌁︙تم تعطيل ردود البوت', 1, 'md')
end end
end
end
